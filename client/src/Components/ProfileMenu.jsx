...
import { CogIcon, ArrowRightOnRectangleIcon } from '@heroicons/react/24/outline';
  ...
  export function ProfileMenu() {
    ...
    return (
      <Menu>
        <MenuHandler>
        <div className="flex items-center justify-center p-2 bg-gray-200 rounded-full hover:bg-gray-300 cursor-pointer">
        ...
        <MenuList>
          ...
          <MenuItem className="flex items-center gap-2">
            ...
            <Typography variant="small" className="font-medium text-gray-700k">
              Edit Profile
            </Typography>
          </MenuItem>
          <MenuItem className="flex items-center gap-2">
          ...
          <MenuItem className="flex items-center justify-center">
            <Typography variant="small" className="font-medium p-0">
